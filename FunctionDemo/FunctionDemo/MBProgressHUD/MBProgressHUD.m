...
@synthesize labelAttributedString;
@synthesize detailAttributedString;
...
- (id)initWithFrame:(CGRect)frame {
	...
	if (self) {
		...
		self.square = NO;
        self.labelAttributedString = nil;
        self.detailAttributedString = nil;
...
- (void)dealloc {
    ...
    [labelAttributedString release];
    [detailAttributedString release];
#if NS_BLOCKS_AVAILABLE
...
- (void)setupLabels {
    ...
    detailsLabel.attributedText = self.detailAttributedString;
...
- (NSArray *)observableKeypaths {
	return [NSArray arrayWithObjects:@"mode", @"customView", @"labelText", @"labelFont", @"labelColor",
			@"detailsLabelText", @"detailsLabelFont", @"detailsLabelColor", @"progress", @"activityIndicatorColor", @"labelAttributedString", @"detailAttributedString", nil];
}
...
- (void)updateUIForKeypath:(NSString *)keyPath {
	if ([keyPath isEqualToString:@"mode"] || [keyPath isEqualToString:@"customView"] ||
		...
		return;
    } else if ([keyPath isEqualToString:@"labelAttributedString"]) {
        label.attributedText = self.labelAttributedString;
    } else if ([keyPath isEqualToString:@"detailAttributedString"]) {
        detailsLabel.attributedText = self.detailAttributedString;
    }
	[self setNeedsLayout];
	[self setNeedsDisplay];
